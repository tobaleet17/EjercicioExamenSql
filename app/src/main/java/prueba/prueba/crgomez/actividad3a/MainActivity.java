...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recuperarSQl = (Button) findViewById(R.id.btnRecuperarSql);
        inserEstu = (Button) findViewById(R.id.btnInsertar);
        inserProfe = (Button) findViewById(R.id.btnInsertar2);
        insertAsigna = (Button) findViewById(R.id.btnInsertarAsig);
        ...
        recuperarSQl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentRecu = new Intent(getApplicationContext(),Recuperar.class);
                startActivity(intentRecu);


            }
        });
        insertAsigna.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intentAsig = new Intent(getApplicationContext(),activityAsignatura.class);
                startActivity(intentAsig);
